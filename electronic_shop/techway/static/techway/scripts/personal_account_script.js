...
function updatePosition() {
    let arr_data = [['label_mail', 'login_input'], ['label_password', 'password_input'], ['label_password_update', 'password_update_input'], ['label_last_name', 'last_name_input'], ['label_first_name', 'first_name_input']]
